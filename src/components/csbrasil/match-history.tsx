                ...
                {matches.length > 0 ? matches.map((match, idx) => (
                    ...
                    >
                        <div className="flex items-center gap-5">
                            <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-black italic shadow-lg ${match.outcome === 'win' ? 'bg-green-500 text-black' : 'bg-red-500 text-white'
                                }`}>
