...
import { Terminal as ConsoleIcon, Map as MapIcon, HardDrive as DemoIcon, Users as UsersIcon, Trophy as MatchesIcon } from 'lucide-react';
...
export function PainelTabs() {
    const [activeTab, setActiveTab] = useState<'server' | 'maps' | 'demos' | 'users' | 'matches'>('server');
